...
public enum Column implements Columnable {
    ...
    public void hide() {
        if (this.isShown()) {
            ...
            List<Column> visibleColumnsList = getVisibleColumns();
            Column[] visibleColumnsArray = visibleColumnsList.toArray(new Column[visibleColumnsList.size()]);
            configureColumns(visibleColumnsArray);
        }
    }
}
